...
func (c *client) GetSupplierByIDs(ctx context.Context, ids []string) (data []Supplier, err error) {
	url := fmt.Sprintf("%s", c.cfg.SupplierURL)
	...
	var response SupplierByIDsResponse
